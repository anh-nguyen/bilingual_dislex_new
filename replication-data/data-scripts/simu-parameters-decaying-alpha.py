...
if __name__ == "__main__":
	make_simu_data("UTBA18.txt", 1400, 0.5, 3, "l2", 180, ["l1", "l2", "sem"], ["l1l2", "sl1", "sl2"])
	make_simu_data("BUBA01.txt", 800, 0.5, 3, "l2", 180, ["l1", "l2", "sem"], ["l1l2", "sl1", "sl2"])
	make_simu_data("UTBA20.txt", 1700, 0.5, 3, "l2", 300, ["l1", "l2", "sem"], ["l1l2", "sl1", "sl2"])
	make_simu_data("UTBA21.txt", 1700, 0.5, 3, "l2", 100, ["l1", "l2", "sem"], ["l1l2", "sl1", "sl2"])
