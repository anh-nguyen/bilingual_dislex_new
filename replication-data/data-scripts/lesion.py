...
if __name__ == "__main__":
	...
	UTBA18_noise_amount = {'l1l2': 0, 'sl1': 0.2, 'sl2': 0.31}
	BUBA01_noise_amount = {'l1l2': 0, 'sl1': 0.4, 'sl2': 0.3}
	UTBA20_noise_amount = {'l1l2': 0, 'sl1': 3.8, 'sl2': 3.8}
	UTBA21_noise_amount = {'l1l2': 0, 'sl1': 2.5, 'sl2': 2.7}
	...
	#lesion_assocs("../../UTBA18-simu", "../../UTBA18-lesioned-simu-test-2", map_sizes, num_reps, UTBA18_noise_amount, UTBA18_overwrite)
	#lesion_assocs("../../BUBA01-simu", "../../BUBA01-lesioned-simu-test", map_sizes, num_reps, BUBA01_noise_amount, BUBA01_overwrite)
